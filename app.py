...
STATUSES = ["intake", "monitoring", "follow-up", "completed"]
...
def create_app(test_config=None):
    ...
    app.config.update(
        ...
        APP_TITLE="Law Firm Case Tracker",
        APP_DESCRIPTION="Production-ready domain application.",
        DOMAIN_LABEL="Health & Wellness",
        ENTITY_SINGULAR="Law Firm Care Record",
        ENTITY_PLURAL="Law Firm Care Records",
    )
